 ...
 * @author KABIR KUMAR
 */
public class del3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ENTER PROJECT ID TO DELETE");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
					...
					PreparedStatement create = con.prepareStatement("delete from Project where PId='"+st+"'");
